...
export function CodeEditor({ content, language, onChange, onSave, onCursorChange, onCmdK, filePath, viewRef: externalViewRef }) {
  ...
  useEffect(() => {
    ...
    const saveKeymap = keymap.of([{
      ...
      run: (view) => {
        ...
        onCmdKRef.current?.({ line: line.number, col: pos - line.from + 1, coords });
        return true;
      },
    }]);
